...
sequenceDiagram
  ...
  Remote Repository ->> Working Directory: git pull or rebase
  Local Repository ->> Working Directory: git checkout
  Local Repository ->> Working Directory: git merge
  Local Repository ->> Working Directory: git reset --hard <commit>
  Staging Area ->> Working Directory: git reset <file>
```
